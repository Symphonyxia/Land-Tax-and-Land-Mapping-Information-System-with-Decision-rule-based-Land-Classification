...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">EDIT Map Profile </h6>
        </div>
                ...
                foreach ($query_run as $row) {
                    ...
                    <form action="code.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="edit_district" value="<?php echo $row['district'] ?>" class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label> Section </label>
                            <input type="text" name="edit_section" value="<?php echo $row['section_no'] ?>"
                                class="form-control">
                        </div>
                        <div class="form-group">
                            <label> Lot No. </label>
                            <input type="text" name="edit_lot_no" value="<?php echo $row['lot_no'] ?>" class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="edit_market" id="marketValueInput" value="<?php echo $row['market_val'] ?>"
                        ...
                        <div class="form-group">
                            <label> No. of Buildings / Structures </label>
                            <input type="text" name="edit_structure" value="<?php echo $row['structures'] ?>"
                                class="form-control">
                        </div>
                        <div class="form-group">
                            <label> No. of Machinery </label>
                            <input type="text" name="edit_machinery" value="<?php echo $row['machinery'] ?>"
                                class="form-control">
                        </div>

                        <div class="form-group">
                            <label>Near Factors Available:</label>
                        ...
                        <div class="form-group">
                            <h5> GPS: <button type="button" onclick="getLocation()" class="btn btn-primary btn-sm my-2 buton">
                                    <i class="fa-solid fa-location-dot"></i></button></h5>
                            <label for="current_loc">Current Location:</label>
                            <textarea id="current_loc" class="form-control" rows="1" name="current_loc"
                                readonly><?php echo isset($row['current_loc']) ? $row['current_loc'] : ''; ?></textarea>
                        </div>


                        <div class="form-group">
                            <label for="longitude">Longitude:</label>
                            <input id="longitude" class="form-control" type="text" rows="1" name="longitude"
                                value="<?php echo isset($row['longitude']) ? $row['longitude'] : ''; ?>">
                        </div>
                        <div class="form-group">
                            <label for="latitude">Latitude:</label>
                            <input id="latitude" class="form-control" type="text" rows="1" name="latitude"
                                value="<?php echo isset($row['latitude']) ? $row['latitude'] : ''; ?>">
                        </div>
                        <div class="form-group">
                            <label for="altitude">Altitude:</label>
                            <input id="altitude" class="form-control" type="text" rows="1" name="altitude"
                                value="<?php echo isset($row['altitude']) ? $row['altitude'] : ''; ?>">
                        </div>
                        <div class="form-group">
                            <label for="accuracy">Precision:</label>
                            <input id="accuracy" class="form-control" type="text" rows="1" name="accuracy"
                                value="<?php echo isset($row['accuracy']) ? $row['accuracy'] : ''; ?>">
                        </div>
                        ...
                        <button type="submit" name="map_update_btn" class="btn btn-primary"> Update </button>
                    </form>
