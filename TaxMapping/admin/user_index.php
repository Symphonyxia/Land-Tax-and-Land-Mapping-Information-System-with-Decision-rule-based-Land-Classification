...
<script>
  ...
  <br>
  <h4 class= 'text-primary'>Land Information</h4>
  ...
  <br>
  <h4 class= 'text-primary'>Additional Data</h4>
  <div id="table-container">
    <?php
    // Assuming you have already established a database connection
  ...
  <br>
  <h4 class= 'text-primary'>Tax Payment History</h4>
  <div id="table-container">
    <?php
    // Assuming you have already established a database connection
    ...
    if (mysqli_num_rows($registerResult) > 0) {
      ...
      $totalLandRecordPayables = $landRecordPayablesRow['total_payables'];
      ...
      echo "<h5 class='card-title text-primary'><strong>Combined Payables:</strong> <strong class = 'text-danger'>$combinedPayables</strong></h5>";
      echo "</div>";
    ...
    echo "</table>";
      ...
      // Pagination links with improved styling
    echo "<div class='pagination'>";
    echo "<ul class='pagination-list'>";
    for ($i = 1; $i <= $totalPages; $i++) {
        echo "<li class='pagination-item'>";
        echo "<a class='pagination-link" . ($i == $page ? " active" : "") . "' href='?page=$i'>$i</a>";
        echo "</li>";
    }
    echo "</ul>";
    echo "</div>";
  }
    // JavaScript to highlight the active pagination link
    echo "<script>";
    echo "document.addEventListener('DOMContentLoaded', function() {";
    echo "let currentPage = $page;";
    echo "let links = document.querySelectorAll('.pagination-link');";
    echo "links.forEach(link => {";
    echo "    if (link.getAttribute('href').includes('page=' + currentPage)) {";
