                  ...
                  <div class="col-lg-12">
                     <div class="p-5">
                        <div class="text-center">
                           <h1 class="h4 text-black-900 font-weight-bold mb-4"> Reset Password</h1>
                           <?php
                        ...
                        <form class="user" action="resetcode.php" method="POST">
                           ...
                           <button type="submit" name="passreset_btn" class="btn btn-primary btn-user btn-block">Send Password Reset Link</button>
                           <br>
                           <div class="text-center">
